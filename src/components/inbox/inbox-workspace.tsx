      ...
      <section className="flex h-full min-w-0 min-h-0 flex-col bg-[#030607]">
        ...
        <div className="bg-[#070b0d] p-5 backdrop-blur">
          ...
          {recorderState === "recording" ? (
            <div className="flex items-center gap-4 rounded-xl bg-[#071013] p-4 shadow-lg ring-1 ring-[#22ddeb]/30">
              <span className="relative flex h-11 w-11 items-center justify-center rounded-full bg-[#351018] text-[#ff7a94]">
                <span className="absolute h-full w-full animate-ping rounded-full bg-[#ff7a94]/20" />
                <Mic className="relative h-5 w-5" />
              </span>
              <div className="min-w-0 flex-1">
                <div className="mb-2 flex items-center justify-between text-sm">
                  <span className="font-semibold text-[#f8fbff]">Recording voice message</span>
                  <span className="font-mono text-[#22ddeb]">{formatRecordingTime(recordingElapsed)}</span>
                </div>
                <div className="flex h-9 items-center gap-1">
                  {recordingLevels.map((height, index) => (
                    <span
                      key={`${height}-${index}`}
                      className="w-1 rounded-full bg-[#22ddeb] transition-all"
                      style={{ height }}
                    />
                  ))}
                </div>
            ...
            <div className="overflow-hidden rounded-xl bg-[#071013] shadow-lg ring-1 ring-[#1d3038]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-2 flex items-center justify-between text-sm">
                    <span className="font-semibold text-[#f8fbff]">Preview before sending</span>
                    <span className="font-mono text-[#22ddeb]">
                  ...
                  <div className="flex h-9 items-center gap-1">
                    {recordingLevels.map((height, index) => (
                      <span
                        key={`${height}-${index}`}
                        className="w-1 rounded-full bg-[#22ddeb]/80"
                        style={{ height }}
                      />
                    ))}
                  </div>
            ...
            <div className="space-y-3">
              {selectedFile ? (
                <div className="flex items-center gap-3 rounded-xl border border-[#1d3038] bg-[#0b1114] px-4 py-3 shadow-lg">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#082529] text-[#22ddeb]">
                    <Paperclip className="h-5 w-5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-semibold text-[#f8fbff]">{selectedFile.name}</div>
                    <div className="mt-0.5 text-xs text-[#8fa3ad]">{formatAttachmentSize(selectedFile.size)}</div>
                  </div>
                  <Button
                    type="button"
                    variant="ghost"
                    ...
                    className="h-9 w-9 text-[#8fa3ad] hover:text-[#ff7a94]"
                  >
                    <X className="h-5 w-5" />
                  </Button>
                </div>
              ) : null}
              <div className="relative flex items-end gap-3 rounded-xl bg-[#070b0d] p-3 shadow-lg ring-1 ring-[#1d3038]">
                {showEmojiPicker && (
                  <div className="absolute bottom-full left-0 mb-4 w-[292px] rounded-xl bg-[#0b1114] p-3 shadow-xl ring-1 ring-[#1d3038]">
                    <div className="grid grid-cols-10 gap-1">
                      {EMOJI_GROUPS.flat().map((emoji) => (
                        <button
                          ...
                          className="flex h-8 w-8 items-center justify-center rounded-lg text-xl transition hover:bg-[#1d3038]"
                        >
                          {emoji}
                        </button>
                      ))}
                ...
                <Button
                  ...
                  className="h-10 w-10 shrink-0 text-[#8fa3ad] hover:text-[#f8fbff]"
                ...
                <textarea
                  ...
                  disabled={!activeConversation || isComposerBusy}
                  rows={1}
                  className="max-h-40 min-h-10 flex-1 resize-none overflow-y-auto bg-transparent px-3 py-2 text-[#f8fbff] outline-none placeholder:text-[#6f858f] disabled:opacity-60"
                />
                <div className="flex shrink-0 items-center gap-2">
                  <Button
                    ...
                    className="h-10 w-10 text-[#8fa3ad] hover:text-[#f8fbff]"
                  >
