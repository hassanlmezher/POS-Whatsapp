      ...
      <Card className="p-7">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl bg-[#0b1114] p-5 ring-1 ring-[#1d3038]"><div className="text-xs uppercase text-[#6f858f]">Total Spent</div><div className="mt-2 text-xl font-black text-[#f8fbff]">{formatCurrency(spent)}</div></div>
            <div className="rounded-xl bg-[#0b1114] p-5 ring-1 ring-[#1d3038]"><div className="text-xs uppercase text-[#6f858f]">Orders</div><div className="mt-2 text-xl font-black text-[#f8fbff]">{orders.length}</div></div>
          </div>
        </div>
      </Card>
